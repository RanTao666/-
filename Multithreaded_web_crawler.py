...
def save_data(result):
    write = pd.ExcelWriter("E:\\scrapy\\VOA\\科技\\VOA科技.xlsx")
...
if __name__ == "__main__":
    ...
    # Initialize the semaphore to limit to 10 concurrent threads
    semaphore = threading.Semaphore(10)
    lock = threading.Lock()
    threads = []

    for page in tqdm(range(1, 500), desc="Processing pages"):
